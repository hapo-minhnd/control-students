...
Route::group(['namespace' => 'Student', 'prefix' => 'student'], function () {
  ...
  Route::group(['middleware' => 'student', 'prefix' => 'home'], function () {
    ...
    Route::get('/pick-semester', 'StudentController@pickSemester')->name('pick_semester_student');
    Route::get('/index-point', 'StudentController@IndexPoint')->name('index_point');
...
Route::group(['namespace' => 'Teacher', 'prefix' => 'teacher'], function () {
  ...
  Route::group(['middleware' => 'teacher', 'prefix' => 'home'], function () {
    ...
    Route::get('/info/student', 'TeacherController@infoStudent')->name('info_student');
    Route::get('/info/student/search', 'TeacherController@infoStudent')->name('search_student_teacher');
    ...
    Route::get('/pick-semester', 'TeacherController@pickSemester')->name('pick_semester');
  });
});
