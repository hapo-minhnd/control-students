...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'admin', 'prefix' => 'home'], function () {
        ...
        Route::get('/update/score/sreach', 'ManageStudentController@indexPoint')->name('sreach_score');
        ...
        Route::post('/update/class/{id}', 'ClassController@destroy')->name('destroy_class_admin');
