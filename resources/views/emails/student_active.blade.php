...
<div class="body">
    <table class="content centered">
        <tr>
            <td>
                <p>Chào mừng tân sinh viên {{ $student->name }} !!!. Bạn hãy click vào đường link sau đây để hoàn tất việc xác thực tài khoản.</p>
            </td>
        </tr>
        <tr>
            <td style="text-align: center !important; padding-top: 25px; padding-bottom: 25px;">
                <a href="{{ route('student.verify',$student->email_token) }}" class="mail-template-btn">Link đăng nhập</a>
            </td>
        </tr>
        <tr>
            <td>
